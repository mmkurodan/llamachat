...
public final class CalendarPromptFactory {
    ...
    public static String buildExplainUserPrompt(String originalUserInput, CalendarResultForChat resultForChat) {
        ...
        sb.append("errorType: ").append(resultForChat == null || resultForChat.getErrorType() == null
                ? "null" : resultForChat.getErrorType()).append("\n");
        sb.append("errorDetail: ").append(resultForChat == null || resultForChat.getErrorDetail() == null
                ? "null" : resultForChat.getErrorDetail()).append("\n");
        sb.append("events:\n");
